...
export default () => (
  <div className='main'>
    ...
    <Container>
      ...
      <p>
        A recent problem my team and I faced was to debug hardware - <a href='https://medium.com/@makers_c_a_c_t_u_s/debugging-hardware-by-ben-82c38ada24bc' target='_blank' rel='noopener noreferrer'>our touch screen stopped working the moment we booted our app</a>, and no errors were thrown to guide our thinking. 'Closing the loop' was our saving grace, and we eliminated possible failures one by one until we found the exact issue.
      </p>
